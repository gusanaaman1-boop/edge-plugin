...
title EDGE - uninstall

rem ---------------------------------------------------------------------------
rem  Removes every plausible EDGE install, in BOTH shapes (folder bundle and
...
set "P1=%CommonProgramFiles%\VST3\EDGE.vst3"
set "P2=%CommonProgramFiles(x86)%\VST3\EDGE.vst3"
set "P3=%ProgramFiles%\Common Files\VST3\EDGE.vst3"
set "P4=%LOCALAPPDATA%\Programs\Common\VST3\EDGE.vst3"
set "P5=%ProgramFiles%\Naaman\EDGE"
...
echo   In Cubase: Studio menu, then VST Plug-in Manager, then Update.
